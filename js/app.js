...
const util = (() => {
    ...
    const tamu = () => {
        ...
        div.innerHTML = `<p class="mt-0 mb-1 mx-0 p-0 text-light" style="font-size: 1.8rem;">Kepada Yth Bapak/Ibu/Saudara/i</p><h2 class="text-light" style="font-size: 2.4rem; font-weight:570">${escapeHtml(name)}</h2>`;
